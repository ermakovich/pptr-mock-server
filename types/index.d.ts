declare module 'pptr-mock-server' {
    ...
    type ResponseBodyFunction = (_: HTTPRequest) => ResponseBody | Promise<ResponseBody>;
    type ResponseBody = Record<string, unknown> | ResponseBodyFunction | string | number | undefined;
    ...
    type MockRequestHandler = (_endpoint: string, _status: number, _response: ResponseOptions) => MockRequest;
    ...
    export interface MockRequest {
       ...
       *
       */
      on(_method: string, _endpoint: string, _status: number, _response: ResponseOptions): MockRequest;
